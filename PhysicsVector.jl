...
abstract type PhysicsVector <: AbstractVector{Number} end
    ...
    struct Position{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"m"), Unitful.FreeUnits{A, dimension(u"m"), nothing}}
        y::Quantity{Float64, dimension(u"m"), Unitful.FreeUnits{B, dimension(u"m"), nothing}}
        z::Quantity{Float64, dimension(u"m"), Unitful.FreeUnits{C, dimension(u"m"), nothing}}
    end
        function Position(x::Number=0.0u"m", y::Number=0.0u"m", z::Number=0.0u"m")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"m")}, (x, y, z))
    ...
    struct Velocity{A,B,C}  <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"m/s"), Unitful.FreeUnits{A, dimension(u"m/s"), nothing}}
        y::Quantity{Float64, dimension(u"m/s"), Unitful.FreeUnits{B, dimension(u"m/s"), nothing}}
        z::Quantity{Float64, dimension(u"m/s"), Unitful.FreeUnits{C, dimension(u"m/s"), nothing}}
    end
        function Velocity(x::Number=0.0u"m/s", y::Number=0.0u"m/s", z::Number=0.0u"m/s")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"m/s")}, (x, y, z))
    ...
    struct Acceleration{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"m/s^2"), Unitful.FreeUnits{A, dimension(u"m/s^2"), nothing}}
        y::Quantity{Float64, dimension(u"m/s^2"), Unitful.FreeUnits{B, dimension(u"m/s^2"), nothing}}
        z::Quantity{Float64, dimension(u"m/s^2"), Unitful.FreeUnits{C, dimension(u"m/s^2"), nothing}}
    end
        function Acceleration(x::Number=0.0u"m/s^2", y::Number=0.0u"m/s^2", z::Number=0.0u"m/s^2")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"m/s^2")}, (x, y, z))
    ...
    struct Jerk{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"m/s^3"), Unitful.FreeUnits{A, dimension(u"m/s^3"), nothing}}
        y::Quantity{Float64, dimension(u"m/s^3"), Unitful.FreeUnits{B, dimension(u"m/s^3"), nothing}}
        z::Quantity{Float64, dimension(u"m/s^3"), Unitful.FreeUnits{C, dimension(u"m/s^3"), nothing}}
    end
        function Jerk(x::Number=0.0u"m/s^3", y::Number=0.0u"m/s^3", z::Number=0.0u"m/s^3")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"m/s^3")}, (x, y, z))
            return Jerk(x, y, z)
        end
    ...
    struct Snap{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"m/s^4"), Unitful.FreeUnits{A, dimension(u"m/s^4"), nothing}}
        y::Quantity{Float64, dimension(u"m/s^4"), Unitful.FreeUnits{B, dimension(u"m/s^4"), nothing}}
        z::Quantity{Float64, dimension(u"m/s^4"), Unitful.FreeUnits{C, dimension(u"m/s^4"), nothing}}
    end
        function Snap(x::Number=0.0u"m/s^4", y::Number=0.0u"m/s^4", z::Number=0.0u"m/s^4")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"m/s^4")}, (x, y, z))
            return Snap(x, y, z)
        end
    ...
    struct AngularVelocity{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"rad/s"), Unitful.FreeUnits{A, dimension(u"rad/s"), nothing}}
        y::Quantity{Float64, dimension(u"rad/s"), Unitful.FreeUnits{B, dimension(u"rad/s"), nothing}}
        z::Quantity{Float64, dimension(u"rad/s"), Unitful.FreeUnits{C, dimension(u"rad/s"), nothing}}
    end
        function AngularVelocity(x::Number=0.0u"rad/s", y::Number=0.0u"rad/s", z::Number=0.0u"rad/s")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"rad/s")}, (x, y, z))
    ...
    struct AngularAcceleration{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"rad/s^2"), Unitful.FreeUnits{A, dimension(u"rad/s^2"), nothing}}
        y::Quantity{Float64, dimension(u"rad/s^2"), Unitful.FreeUnits{B, dimension(u"rad/s^2"), nothing}}
        z::Quantity{Float64, dimension(u"rad/s^2"), Unitful.FreeUnits{C, dimension(u"rad/s^2"), nothing}}
    end
        function AngularAcceleration(x::Number=0.0u"rad/s^2", y::Number=0.0u"rad/s^2", z::Number=0.0u"rad/s^2")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"rad/s^2")}, (x, y, z))
    ...
    struct Momentum{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"kg*m/s"), Unitful.FreeUnits{A, dimension(u"kg*m/s"), nothing}}
        y::Quantity{Float64, dimension(u"kg*m/s"), Unitful.FreeUnits{B, dimension(u"kg*m/s"), nothing}}
        z::Quantity{Float64, dimension(u"kg*m/s"), Unitful.FreeUnits{C, dimension(u"kg*m/s"), nothing}}
    end
        function Momentum(x::Number=0.0u"kg*m/s", y::Number=0.0u"kg*m/s", z::Number=0.0u"kg*m/s")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"kg*m/s")}, (x, y, z))
    ...
    struct AngularMomentum{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"N*m*s"), Unitful.FreeUnits{A, dimension(u"N*m*s"), nothing}}
        y::Quantity{Float64, dimension(u"N*m*s"), Unitful.FreeUnits{B, dimension(u"N*m*s"), nothing}}
        z::Quantity{Float64, dimension(u"N*m*s"), Unitful.FreeUnits{C, dimension(u"N*m*s"), nothing}}
    end
        function AngularMomentum(x::Number=0.0u"N*m*s", y::Number=0.0u"N*m*s", z::Number=0.0u"N*m*s")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"N*m*s")}, (x, y, z))
    ...
    struct Torque{A,B,C} <: PhysicsVector where {A,B,C}
        x::Quantity{Float64, dimension(u"N*m"), Unitful.FreeUnits{A, dimension(u"N*m"), nothing}}
        y::Quantity{Float64, dimension(u"N*m"), Unitful.FreeUnits{B, dimension(u"N*m"), nothing}}
        z::Quantity{Float64, dimension(u"N*m"), Unitful.FreeUnits{C, dimension(u"N*m"), nothing}}
    end
        function Torque(x::Number=0.0u"N*m", y::Number=0.0u"N*m", z::Number=0.0u"N*m")
            ...
            x, y, z = convert.(Quantity{Float64, dimension(u"N*m")}, (x, y, z))
            return Torque(x, y, z)
        end
